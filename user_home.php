...
<div class="container conainer-padding">
  <div class="content">
    ...
    <div class="ticket-count-form">
        <form name="ticket-count" method="post" action="controller/update_ticket.php">
        <br>
            <label for="category">TYPE FEW CHARACTERS OF THE CATEGORY YOU WANT TO USE</label><br>
      ...
      <div class="container page-wrapper" id="inc">
        ...
        <p><span class="heading_text">TICKETS LOGGED THIS WEEK</span></p>
          ...
          <div class="row">
             ...
             <div class=" zero-padding col-xs-12 col-md-4 columns">
            <p><span class="glyphicon glyphicon-stats" aria-hidden="true"></span></p>
              <p><span class="heading_text">INCIDENT TREND IN PREVIOUS WEEK</span></p>
              <center><?php include('controller/incident_trend_pr_week.php'); ?></center>
            </div>
         
          <div class=" zero-padding col-xs-12 col-md-4 mid-column columns">
            <p><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span></p>
        <!-- </button> -->
        <p><span class="heading_text">TICKETS LOGGED LAST WEEK</span></p>
              <center><?php include('controller/incident_count_pre_week.php');?></center>
            </div> 


          <div class=" zero-padding col-xs-12 col-md-4 columns">
            <p><span class="glyphicon glyphicon-erase" aria-hidden="true"></span></p>
              <p><span class="heading_text">CLEANING TICKETS LAST WEEK</span></p>
              <center><?php include('controller/cleaning_count_pre_week.php'); ?></center>
            </div>
          </div>
