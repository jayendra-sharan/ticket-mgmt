...
<div class="container conainer-padding page-wrapper">
...
<div class="container conainer-padding">
     <div class"wr_inc_rep">
     <h3>Here is the detail of what users are doing wrong!</h3><br>
     <center><?php include('controller/report.php'); ?></center>
     </div>
     <span class="sepa_black"></span>
     <div class="ao_inc_rep">
       <h3>These issues need to be tracked!</h3><br>
       <center><?php include('controller/ao_report.php'); ?></center>
     </div>
